    ...
    <>
      ...
      >
        <Box width="100%" display="flex" justifyContent="center" alignItems="center">
          <Typography sx={{ color: "contrast.main", textShadow: "none", fontFamily: "sans-serif" }}>
        ...
        <Box
          ...
          alignItems="center"
        >
          <img src={Logo} alt="Logo Image" width="30px" />
        </Box>
...
const StyledIcon = styled(IconButton)(({ theme }) => ({
  "&:hover": {
    boxShadow: `0 4px 6px -1px rgba(150, 0, 255, 0.5)`, // Adjust the shadow properties
